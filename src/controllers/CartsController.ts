...
export class CartsController {
    ...
    public addProductToCart = async (req: Request, res: Response) => {
        try {
            ...
            const input: AddProductToCartInput = this.cartsDTO
                .addProductToCartInput(
                    userToken,
                    productId,
                    productAmount
    ...
    public updateProductAmountInCart = async (req: Request, res: Response) => {
        try {
            ...
            const input: UpdateProductAmountInCartInput = this.cartsDTO
    ...
    public deductProductFromCart = async (req: Request, res: Response) => {
        try {
            ...
            const input: DeductProductFromCartInput = this.cartsDTO
                .deductProductFromCartInput(
                    userToken,
                    productId
                )
