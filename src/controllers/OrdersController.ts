...
import {
    ...
    GetOrderByIdInput, GetOrderByIdOutput,
    GetOrdersByUserInput, GetOrdersByUserOutput,
    OrdersDTO,
...
export class OrdersController {
    ...
    public createNewOrder = async (req: Request, res: Response) => {
        try {
            ...
            const input: CreateNewOrderInput = this.ordersDTO.createNewOrderInput(userToken, productsId, productsAmount)
    ...
    public getOrderById = async (req: Request, res: Response) => {
        try {
            ...
            const input: GetOrderByIdInput = this.ordersDTO.getOrderByIdInput(userToken, orderId)
    ...
    public updateOrderById = async (req: Request, res: Response) => {
        try {
            ...
            const input: UpdateOrderInput = this.ordersDTO.updateOrderInput(orderId, paidStatus)
    ...
    public deleteOrderById = async (req: Request, res: Response) => {
        try {
            const userToken = req.headers.authorization
            const { orderId } = req.body
            const input: DeleteOrderInput = this.ordersDTO.deleteOrderInput(userToken, orderId)
