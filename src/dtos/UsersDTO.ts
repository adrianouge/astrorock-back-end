...
export class UsersDTO {
    ...
    public createNewOrderInput(userToken: unknown): CreateNewOrderInput {
        ...
        if(typeof userToken !== "string") {
            throw new BadRequestError("O tipo do token do usuário deve ser do tipo string.")
        }
    ...
    public createNewOrderOutput(userOrder: orderDB): CreateNewOrderOutput {
    ...
    public updateOrderInput(orderId: unknown, orderPaid: unknown): UpdateOrderInput {
        if(typeof orderId !== "string") {
            throw new BadRequestError("O tipo do id da compra deve ser do tipo string.")
        }

        if(typeof orderPaid !== "number") {
            throw new BadRequestError("O tipo do valor compra paga deve ser do tipo number.")
        }
    ...
    public updateOrderOutput(paidOrder: orderDB): UpdateOrderOutput {

        const dto: UpdateOrderOutput = {
            message: `A compra ${paidOrder.id} foi paga em ${paidOrder.paymentDate} com sucesso.`
        }
